...
IPDNET instead of DOA values parsed from the target filename.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run IPDNET -> DSENet -> Whisper in one process.")
...
def main() -> None:
    ...
    summary = {
        ...
        "mean_ipdnet_sec": float(np.mean([r.ipdnet_sec for r in all_results])) if all_results else 0.0,
