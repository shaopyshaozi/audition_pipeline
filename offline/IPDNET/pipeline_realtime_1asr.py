...
Loads IPDNET, DSENet, and Whisper once, then processes each saved
...
def postprocess_doa_from_tensors(
    ...
    """
    Cluster active IPDNET DOA points into exactly num_sources DOAs.

    IPDNET's pred2DOA output uses a similarity score, so active frames are
    selected by score > vad_th, matching the examples under Models/SSL/IPDNET/DOA_eval.
    """
