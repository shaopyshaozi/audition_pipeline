...
DEFAULT_CSV_PATH = SCRIPT_ROOT / "results" / "pipeline_whisper_small_wer_details_1asr.csv"
DOA_THRESHOLD_DEG = 360.0
...
def main() -> None:
    ...
    subset = valid_df[valid_df["selected_doa_error_deg"] <= args.doa_threshold_deg]
