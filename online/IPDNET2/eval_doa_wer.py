...
DEFAULT_CSV_PATH = SCRIPT_ROOT / "results" / "pipeline_streaming_small_scene_wer_1asr_4s_full.csv"
DOA_THRESHOLD_DEG = 20.0


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Summarise WER below a mean selected DOA-error threshold.")
