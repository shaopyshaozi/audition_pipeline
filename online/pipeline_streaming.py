...
def main() -> None:
    ...
    transcript_jsonl = args.out_dir / f"pipeline_streaming_{args.whisper_model}_transcripts_full.jsonl"
    ...
    details_csv = args.out_dir / f"pipeline_streaming_{args.whisper_model}_details_1asr_full.csv"
    ...
    summary_json = args.out_dir / f"pipeline_streaming_{args.whisper_model}_summary_1asr_full.json"
