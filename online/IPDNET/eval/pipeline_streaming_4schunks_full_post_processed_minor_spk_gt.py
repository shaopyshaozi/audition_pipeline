"""
Online-style GT-DoA -> DSE -> streaming ASR realtime benchmark.

Loads DSENet once, then chops each long Respeaker mic-array
...
1. Read filename DoA2 as the source-2 target direction.
2. Run DSENet once with that ground-truth DoA2.
3. Send the enhanced source-2 output to streaming Whisper.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ipd_ckpt", type=Path, default=SSL_ROOT / "last-v1.ckpt", help="Unused in this GT-DoA2 script.")
...
def main() -> None:
    ...
    print("DSENet batch size: 1 GT DoA2 target per chunk")
    ...
    print("SSL/IPDNET disabled: using filename DoA2 directly for DSENet.")
    ...
    summary = {
        ...
        "device": args.device,
        "use_ssl": False,
        "dse_batch_size": "one_gt_filename_doa2",
        "selection": "ground_truth_filename_doa2_no_ssl",
    ...
    print(
        ...
        f"GT-DoA lookup={summary['mean_ipdnet_sec']:.3f}s, "
