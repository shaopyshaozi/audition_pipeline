...
result = evaluate_one_file_with_csv(
        doaest_path=fr"D:\邵鹏远\UCL\博1\code\FN-SSL\IPDnet\inference_results\{scene_index}_doaest.npy",
        vadest_path=fr"D:\邵鹏远\UCL\博1\code\FN-SSL\IPDnet\inference_results\{scene_index}_vadest.npy",
        csv_path=r"D:\邵鹏远\UCL\博1\code\FN-SSL\IPDnet\inference_results\ground_truth.csv",
